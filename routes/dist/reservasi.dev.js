...
router.post('/update-status/:id', function _callee3(req, res) {
  var id_reservasi, status, reservasi, id_jadwal;
  return regeneratorRuntime.async(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 12:
          reservasi = _context3.sent;
          id_jadwal = reservasi[0].id_jadwal;
...
router.post('/update/:id', function _callee4(req, res) {
  var id, _req$body, status, catatan, dataToUpdate, reservasiData, id_jadwal, _Model_Jadwal, Model_Notifikasi, notif;
  ...
  return regeneratorRuntime.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 10:
          id_jadwal = reservasiData[0].id_jadwal;
          _Model_Jadwal = require('../models/Model_Jadwal');
          Model_Notifikasi = require('../models/Model_Notifikasi'); // 🔹 Update status reservasi
        ...
        case 15:
          ...
          _context4.next = 18;
          return regeneratorRuntime.awrap(_Model_Jadwal.Update(id_jadwal, {
            status_slot: 'terisi'
          }));
        ...
        case 28:
          ...
          notif = {
            ...
            isi_pesan: status === 'disetujui' ? "Booking Anda untuk arena ".concat(reservasiData[0].nama_arena, " telah disetujui.") : status === 'ditolak' ? "Maaf, booking Anda untuk arena ".concat(reservasiData[0].nama_arena, " ditolak.") : status === 'selesai' ? "Terima kasih telah bermain di ".concat(reservasiData[0].nama_arena, ".") : "Status booking Anda telah berubah menjadi ".concat(status, "."),
            jenis_notif: 'status',
            tipe: 'booking',
            dibaca: 0
          };
        ...
        case 36:
          ...
          req.flash('error_msg', 'Gagal memperbarui reservasi: ' + _context4.t0.message);
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 7:
          ...
          req.flash('error_msg', 'Gagal menghapus reservasi: ' + _context5.t0.code);
          res.redirect('/reservasi');
